...
client.on("message", message => {
 if (message.content === ".help-admin") {
  const embed = new Discord.RichEmbed()
	  ...
	  .addField('.mutechannel', `لااقفال الروم و ما حدا يشوفو من الاعضاء`)
	  .addField('.unmutechannel', `لفتح الروم و الكل يكدر يشوفه`)
      .setFooter('─═════════ {✯LegendryBot✯} ════════════─')
 ...
 if (message.content === ".help-public") {
  const embed = new Discord.RichEmbed()
	  ...
	  .addField('.members', `حاله الاعضاء`)
          .addField('.suggest', `لاقتراح شي لازم يكون في روم اسمو (suggestions)`)
          	  .addField('.report', `عشان تبلغ عن شخص`)
          	            	  .addField('.contact', `لارسال رسالة لـ صاحب البوت`)
      	  .addField('.cat', `يجيك صورة قطة`)
      	  .addField('.uptime', `لمعرفة من متي البوت شغال`)
...
client.on('guildCreate', guild => {
  client.channels.get("475436161997733902").send(`**Woops new server ✅
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``My ID``' , `[ ${client.user.id} ]` , true)
                  ...
                  .setFooter('By |<@373670599463272448>')
    })
}
});
